...
<body>
                        ...
                        <div class="about-content">
                            <div class="section-title-area">
                                ...
                                <p class="desc">Welcome to Sutdykids, where education meets inspiration, and every
                                    child's journey is a story of growth and discovery.</p>
                            </div>
                                ...
                                <li class="wrapper-list">
                                    <div class="list-inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="desc">At studykids our mission is to cultivate
                                ...
                                <li class="wrapper-list">
                                    <div class="list-inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="desc">As we embark on the journey of education
    ...
    <section class="rts-about-area area-2 rts-shape-move rts-section-gap section-bg2">
                            ...
                            <div class="video-btn-area">
                                <div class="vedio-icone">
                                    <a class="video-play-button play-video popup-video"
                                        ...
                                        <span class="icon"><img src="assets/images/icon/round-shape.svg"
                                                width="80" alt=""></span>
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="assets/images/banner/shape/25.svg"
                    alt="shape_image"></div>
            <div class="shape two" data-speed="0.04" data-revert="true"><img src="assets/images/banner/shape/26.svg"
                    alt="shape_image"></div>
            <div class="shape three" data-speed="0.04"><img src="assets/images/banner/shape/27.svg"
                    alt="shape_image"></div>
            <div class="shape four" data-speed="0.04"><img src="assets/images/banner/shape/28.svg"
                    alt="shape_image"></div>
            <div class="shape five" data-speed="0.04" data-revert="true"><img
                    src="assets/images/banner/shape/29.svg" alt="shape_image"></div>
            <div class="shape six" data-speed="0.04" data-revert="true"><img src="assets/images/banner/shape/02.svg"
                    alt="shape_image"></div>
        </div>
    </section>
    <!-- about area end -->
    ...
    <!-- course area start -->
    <section class="rts-team-area rts-section-gap inner">
        <div class="container">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="team-wrapper">
                                <div class="wrapper-inner">
                                    <div class="image">
                                        ...
                                        <ul class="social-area">
                                            <li><a href="#"><img src="assets/images/instructor/social-01.svg"
                                                        alt=""></a></li>
                                            <li><a href="#"><img src="assets/images/instructor/social-02.svg"
                                                        alt=""></a></li>
                                            <li><a href="#"><img src="assets/images/instructor/social-03.svg"
                                                        alt=""></a></li>
                                            <li><a href="#"><img src="assets/images/instructor/social-04.svg"
                                                        alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="content">
                                    <h4 class="title"><a href="#">First Teacher</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- single swiper style -->
                        ...
                        <div class="swiper-slide">
                            <div class="team-wrapper">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Second Teacher</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- single swiper style -->
                        ...
                        <div class="swiper-slide">
                            <div class="team-wrapper">
                                ...
                                <div class="content">
                                    <h4 class="title"><a href="#">Third Teacher</a></h4>
                                </div>
                            </div>
                        </div>
                        <!-- single swiper style -->
