...
<head>
    ...
    <title>{{ env('APP_NAME') }} where faith meets passion. </title>
                                ...
                                <div class="video-btn-area">
                                    <div class="vedio-icone">
                                        <a class="video-play-button play-video popup-video"
                                            ...
                                            <span class="icon"><img src="assets/images/banner/play.svg"
                                                    alt=""></span>
                                        </a>
                                        ...
                                        <div class="bottom-wrapper">
                                            <div class="author-area">
                                                <div class="autor-image">
                                                    <img src="assets/images/course/author-01.png" width="40"
                                                        alt="">
                                                </div>
                                ...
                                <div class="wrapper-inner bg-four">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom-wrapper">
                                            <div class="author-area">
                                                <div class="autor-image">
                                                    <img src="assets/images/course/author-02.png" width="40"
                                                        alt="">
                                                </div>
                                ...
                                <div class="wrapper-inner bg-two">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom-wrapper">
                                            <div class="author-area">
                                                <div class="autor-image">
                                                    <img src="assets/images/course/author-03.png" width="40"
                                                        alt="">
                                                </div>
                                ...
                                <div class="wrapper-inner bg-three">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="bottom-wrapper">
                                            <div class="author-area">
                                                <div class="autor-image">
                                                    <img src="assets/images/course/author-04.png" width="40"
                                                        alt="">
                                                </div>
    ...
    <section class="rts-blog-area rts-section-gap">
        <div class="container">
            <div class="section-title-area text-center">
                <p class="pre-title justify-content-center"><img src="assets/images/banner/title-img.svg"
                        alt="">Blog & News</p>
                <h2 class="section-title">Welcome to {{ env('APP_NAME') }} blog</h2>
                <p class="desc">A quick directory of {{ env('APP_NAME') }} most popular blogs on parenting, <br> homeschooling,
                    curriculum, supplementing your kids</p>
            </div>
            <div class="slider-inner">
                <div class="swiper mySwiper-category-1 swiper-data"
                    data-swiper='{
                        ...
                        <div class="footer-single-wized left-logo">
                            ...
                            <div class="body">
                                ...
                                <ul class="wrapper-list">
                                    ...
                                    <li><i class="fa-regular fa-phone"></i><a href="tel:+4733378901">+(61)
                                            485-826-710</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="body">
                                <ul>
                                    <li class="post-area">
                                        <div class="image">
                                            <a href="#">
                                                <img src="assets/images/blog/blog-07.jpg" width="80"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <p class="date">October 29, 2023</p>
                                            <h6 class="post-title"><a href="#">Avoid These 4 Common When
                                                    Managing Remote Teams</a></h6>
                                        </div>
                                    </li>
                                    <li class="post-area">
                                        <div class="image">
                                            <a href="#">
                                                <img src="assets/images/blog/blog-08.jpg" width="80"
                                                    alt="">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <p class="date">October 29, 2023</p>
                                            <h6 class="post-title"><a href="#">How To Draw Realistic Lips In 7
                                                    Simple Steps</a></h6>
                                        </div>
                                    </li>
                                </ul>
                ...
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            <li><a class="mobile-menu-link" href="index-2.html">Home 01</a></li>
                    ...
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse">
                            ...
                            <li><a class="mobile-menu-link" href="blog-right-sidebar.html">Blog Right Sidebar</a>
                            </li>
